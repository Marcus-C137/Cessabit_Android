...
public class Port4Fragment extends Fragment implements NewTempDialogFragment.OnNewTemp {
    ...
    public void onStart(){
        ...
        ArrayList<Float> powers = devicePage._firebaseData.getPowersP4();
        ...
        br = new BroadcastReceiver(){
            ...
            public void onReceive(Context context, Intent intent) {
                if("com.zagermonitoring.FIREBASE_NEWDATA".equals(intent.getAction())){
                    FirebaseTimeTemp ftt = intent.getParcelableExtra("com.zagermonitoring.FIREBASE_NEWTEMP_P4");
    ...
    private void setUpButtons(){
        setTempBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setTargetFragment(Port4Fragment.this, 1);
    ...
    private void setUpSeek(){
        tempSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                fillTempChart(devicePage._firebaseData.getTempsP4(), devicePage._firebaseData.getTimes());
            }
        ...
        powerSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                fillPowerChart(devicePage._firebaseData.getPowersP4(), devicePage._firebaseData.getTimes());
            }
