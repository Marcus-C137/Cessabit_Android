 ...
 * Use the {@link Port2Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Port2Fragment extends Fragment implements NewTempDialogFragment.OnNewTemp{

    private static final String TAG = "Port2Fragment";
    private static final int portIndex = 1;
    ...
    public static Port2Fragment newInstance(String param1, String param2) {
        Port2Fragment fragment = new Port2Fragment();
    ...
    public void onStart(){
        ...
        scrollView = getView().findViewById(R.id.ScrollView_p2);
        tempSeekBar = getView().findViewById(R.id.sb_temp_p2);
        tempChart = getView().findViewById(R.id.bc_currentTemps_p2);
        powerSeekBar = getView().findViewById(R.id.sb_power_p2);
        powerChart = getView().findViewById(R.id.PowerChart_p2);
        switchPortOn = getView().findViewById(R.id.sw_portOn_p2);
        setTempBtn = getView().findViewById(R.id.btn_sp_p2);
        lowAlarmBtn = getView().findViewById(R.id.btn_la_p2);
        highAlarmBtn = getView().findViewById(R.id.btn_ha_p2);
        setUpSeek();
        setUpChart();
        ArrayList<Long> times = devicePage._firebaseData.getTimes();
        ArrayList<Float> temps = devicePage._firebaseData.getTempsP2();
        ArrayList<Float> powers = devicePage._firebaseData.getPowersP2();
        ...
        br = new BroadcastReceiver(){
            ...
            public void onReceive(Context context, Intent intent) {
                if("com.zagermonitoring.FIREBASE_NEWDATA".equals(intent.getAction())){
                    FirebaseTimeTemp ftt = intent.getParcelableExtra("com.zagermonitoring.FIREBASE_NEWTEMP_P2");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_port2, container, false);
    }
    ...
    private void setUpButtons(){
        setTempBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setTargetFragment(Port2Fragment.this, 1);
    ...
    private void setUpSeek(){
        tempSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                fillTempChart(devicePage._firebaseData.getTempsP2(), devicePage._firebaseData.getTimes());
            }
        ...
        powerSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                fillPowerChart(devicePage._firebaseData.getPowersP2(), devicePage._firebaseData.getTimes());
            }
