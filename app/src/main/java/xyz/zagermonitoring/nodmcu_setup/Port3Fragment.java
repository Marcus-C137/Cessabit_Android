 ...
 * Use the {@link Port3Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Port3Fragment extends Fragment implements NewTempDialogFragment.OnNewTemp {
    private static final String TAG = "Port3Fragment";
    private static final int portIndex = 2;
    ...
    public void onStart(){
        ...
        scrollView = getView().findViewById(R.id.ScrollView_p3);
        tempSeekBar = getView().findViewById(R.id.sb_temp_p3);
        tempChart = getView().findViewById(R.id.bc_currentTemps_p3);
        powerSeekBar = getView().findViewById(R.id.sb_power_p3);
        powerChart = getView().findViewById(R.id.PowerChart_p3);
        switchPortOn = getView().findViewById(R.id.sw_portOn_p3);
        setTempBtn = getView().findViewById(R.id.btn_sp_p3);
        lowAlarmBtn = getView().findViewById(R.id.btn_la_p3);
        highAlarmBtn = getView().findViewById(R.id.btn_ha_p3);
        setUpSeek();
        setUpChart();
        ArrayList<Long> times = devicePage._firebaseData.getTimes();
        ArrayList<Float> temps = devicePage._firebaseData.getTempsP3();
        ArrayList<Float> powers = devicePage._firebaseData.getPowersP3();
        ...
        br = new BroadcastReceiver(){
            ...
            public void onReceive(Context context, Intent intent) {
                if("com.zagermonitoring.FIREBASE_NEWDATA".equals(intent.getAction())){
                    FirebaseTimeTemp ftt = intent.getParcelableExtra("com.zagermonitoring.FIREBASE_NEWTEMP_P3");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_port3, container, false);
    }
    ...
    private void setUpButtons(){
        setTempBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setTargetFragment(Port3Fragment.this, 1);
    ...
    private void setUpSeek(){
        tempSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                fillTempChart(devicePage._firebaseData.getTempsP3(), devicePage._firebaseData.getTimes());
            }
        ...
        powerSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                fillPowerChart(devicePage._firebaseData.getPowersP3(), devicePage._firebaseData.getTimes());
            }
